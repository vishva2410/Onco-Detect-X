...
class PerceptionService:
    def predict(self, image_data: bytes, cancer_type: str) -> PerceptionOutput:
        ...
        # Use a deterministic seed based on the image content
        # This ensures that the same image always yields the same confidence/prediction
        # allowing downstream services (like CognitiveService) to cache results effectively.
        ...
        # Note: We use the seeded rng for all random operations
        if rng.random() < 0.1:
            prediction = "normal"
